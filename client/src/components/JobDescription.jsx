  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Loaction: <span className="pl-4 font-normal text-gray-800">Hyderabad</span></h1>
        <h1 className="font-bold my-1">Description: <span className="pl-4 font-normal text-gray-800">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente quam quod consectetur quaerat mollitia alias iste non molestiae aperiam voluptates.</span></h1>
        ...
        <h1 className="font-bold my-1">Posted Date: <span className="pl-4 font-normal text-gray-800">13-12-2024</span></h1>
      </div>
    </div>
  )
}
